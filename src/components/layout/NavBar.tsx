      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center py-4">
          ...
          >
            ...
            <span className="text-xl font-bold">Quantum Coin</span>
          </Link>
          ...
          <div className="hidden md:flex items-center space-x-1">
            ...
            <Link
              to="/crypto-market"
              className={`px-3 py-2 rounded-md text-sm font-medium text-gray-300 hover:text-white ${
                currentPath === "/crypto-market" ? "text-purple-400" : ""
              }`}
            >
              Markets
            </Link>
            <Link
              to="/wallet"
              className={`px-3 py-2 rounded-md text-sm font-medium text-gray-300 hover:text-white ${
                currentPath === "/wallet" ? "text-purple-400" : ""
              }`}
            >
              Wallet
            </Link>
            ...
            <div className="relative group">
              ...
              <div className="absolute left-0 mt-2 w-48 rounded-md shadow-lg bg-black/90 backdrop-blur-md ring-1 ring-black ring-opacity-5 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 ease-in-out">
                <div className="py-1 border border-gray-800 rounded-md">
                  <Link
                    to="/quantum-circuits"
                    className="block px-4 py-2 text-sm text-gray-300 hover:bg-purple-900/30 hover:text-white"
                  >
                    Quantum Circuits
                  </Link>
                  <Link
        ...
        {isMenuOpen && (
          <div className="md:hidden py-3 space-y-2 pb-5">
            ...
            <Link
              to="/wallet"
              className={`block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:bg-gray-800 hover:text-white ${
                currentPath === "/wallet" ? "bg-purple-900/30 text-white" : ""
              }`}
              onClick={() => setIsMenuOpen(false)}
            >
              Wallet
